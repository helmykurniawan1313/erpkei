    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Edit Client</h4>
                        ...
                        <form method="POST" action="/dashboard/clients/{{ $client->id }}" class="mb-5" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control " id="name" name="name" required autofocus value="{{ old('name', $client->name) }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_logo" class="col-form-label"> Client Logo</label>
                                    <input type="hidden" name="oldImage" value="{{ $client->image }}">
                                    <input type="file" class="filestyle"  data-buttontext="Select Image" data-buttonname="btn-primary" accept="image/*" id="client_logo" name="client_logo"  onchange="previewImage()">
                                    <BR>
                                    <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="{{ $client->client_logo ? asset('storage/' . $client->client_logo) : '' }}" height="200">
                            ...
                            <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">Update Client</button>
                        </form>
                    </div>
                </div>
            </div>
