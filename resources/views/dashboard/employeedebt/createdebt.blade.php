        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">TAMBAH HUTANG | {{ $performer_name }}</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Tambah Hutang </h4>
                        <p class="text-muted m-b-30 font-13">

                        </p>
                        <form method="POST" action="/dashboard/employeedebt/createdebt" class="mb-5" enctype="multipart/form-data">
                            @csrf
                            <input hidden id="transaction_category_id" name="transaction_category_id" value="4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="category" class="col-form-label"> Pengaju Hutang</label>
                                    <select required class="form-control select2" name="performer_id" required disabled>
                                        <option value="">Pilih Nama Pengaju Hutang</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select required class="form-control select2" name="cashflow_category_id" required disabled>
                                        ...
                                        <option value="2" selected>Tambah Hutang</option>
                                    </select>
                                    <input type="hidden" name="cashflow_category_id" value="2">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">Tambah Hutang {{ $performer_name }}</button>
                        </form>
