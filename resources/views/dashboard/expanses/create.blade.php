        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">TAMBAH PENGELUARAN</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Tambah Catatan Pengeluaran</h4>
                        <p class="text-muted m-b-30 font-13">

                        </p>
                        <form method="POST" action="/dashboard/expanses" class="mb-5" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">Tambah Pengeluaran</button>
                        </form>
                    </div>
                </div>
            </div>
