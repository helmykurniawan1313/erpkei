        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">EDIT DATA PEMASUKAN</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Ubah Data Pemasukan</h4>
                        <p class="text-muted m-b-30 font-13">

                        </p>
                        <form method="POST" action="/dashboard/incomes/{{ $cashflow->id }}" class="mb-5" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            ...
                            <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">Ubah Data Pemasukan</button>
                        </form>
                    </div>
                </div>
            </div>
