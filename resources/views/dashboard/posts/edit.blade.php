                        ...
                        <form method="POST" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <br>
                                    <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="{{ $post->image ? asset('storage/' . $post->image) : '' }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="body" class="col-form-label">Blog Body Text</label>
                                    <textarea class="summernote" id="body" type="text" name="body" value="{{ old('body', $post->body) }}">{{ $post->body }}
