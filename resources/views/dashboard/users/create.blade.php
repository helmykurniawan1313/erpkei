        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">TAMBAH PENGGUNA BARU</h4>
                        ...
                        <form method="POST" action="/dashboard/users" class="mb-5" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required autofocus placeholder="Masukkan Nama" value="{{ old('name') }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="name" class="col-form-label">Username<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" id="username" name="username" required autofocus placeholder="Masukkan Username Baru" value="{{ old('username') }}">
                                    <span id="usernameCheck"></span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="name" class="col-form-label">Email <span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" id="email" name="email" parsley-type="email" required autofocus placeholder="Masukkan Email" value="{{ old('email') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="department" class="form-control" name="department_id" required>
                                        ...
                                        <option value="{{ $department->id }}">{{ $department->department_category_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="division" class="col-form-label">Divisi</label>
                                    <select id="division" class="form-control" name="division_id" required disabled>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input data-parsley-equalto="#pass1" type="password" required placeholder="Konfirmasi Password" class="form-control" id="passWord2">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">Buat Pengguna Baru</button>
                        </form>
